        ...
        <div className="App">
            <section className="main">
                ...
                <div className="item10">
                    <h1 className="end__title">Sunnyside</h1>
                    <div>
                        <ul className="end__items">
                ...
                <div className="footer">
                    ...
                    <p>
                        . Coded by <a href="#">Mahaboob Shaik</a>.
                    </p>
                </div>
            </section>
        </div>
